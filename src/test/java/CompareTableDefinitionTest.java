...
public class CompareTableDefinitionTest {
    ...
    public void testCompareTablesInDatabases(){
        String databaseConnectionUrl1="jdbc:postgresql://localhost:5432/postgres?user=durga&password=abc123";
        String databaseConnectionUrl2="jdbc:postgresql://localhost:5432/postgres?user=durga&password=abc123";
        String table1="em";
        String table2="em";
